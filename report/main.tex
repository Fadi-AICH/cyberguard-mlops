...
\chapter{Interface Analyste SOC}
\includegraphics[width=\textwidth]{../screenshots/v2_16_streamlit_soc_analyst_ui.png}
L'interface Streamlit fournit une couche operationnelle pour l'analyste: priorisation des evenements, cartographie des sources, diagramme pays/serveur, scoring en direct via FastAPI et export de note d'incident.
